...
~~~sh
# getting the code
git clone git@github.com:nko4/all-seeing-eye.git && cd ./all-seeing-eye/

# developing
npm install
npm start

# deploying (to http://all-seeing-eye.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@all-seeing-eye.2013.nodeknockout.com
ssh root@all-seeing-eye.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@all-seeing-eye.2013.nodeknockout.com
ssh -i ./id_deploy root@all-seeing-eye.2013.nodeknockout.com
~~~
